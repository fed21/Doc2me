...
throw new Error("Module parse failed: Invalid regular expression: /^[0-9]{1,2}-[0-9]{1,2}-[0-9]{4}+$/: Nothing to repeat (5:20)\nFile was processed with these loaders:\n * ./node_modules/babel-loader/lib/index.js\nYou may need an additional loader to handle the result of these loaders.\n|   var show = 0;\n|   var date = document.getElementById(\"reservationDate\").value;\n>   var data_valid = /^[0-9]{1,2}-[0-9]{1,2}-[0-9]{4}+$/;\n|   $('#disp').click(function () {\n|     if (!$(\"#reservationDate\").val() || !data_valid.test(date)) {");

/***/ })

/******/ });
//# sourceMappingURL=disp-805e43c7056e76ac2f27.js.map